...
def pdf2word():
    ...
    try:
        ...
        if uploaded_file is not None:
            # Ask user for output file name
            output_file_name = st.text_input("Output file name", "output.doc")
            ...
            if st.button("Convert to word"):
                if uploaded_file is None:
                    ...
                    # Show download success message
                    st.success("Your Word document file has been downloaded successfully!")
...
def main():
    ...
    menu = ["Home", "Image to Sketch", "Image To PDF" , "Rotate Image", "Trim Video", "Crop Image", "Image Resizer", "Word To PDF", "PDF To Word", "Youtube Video Downloader", "Video To Audio"]
