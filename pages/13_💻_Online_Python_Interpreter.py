...
def compiler_app():
    st.set_page_config(page_title="Online Python Interpreter!!", page_icon=":computer:", layout="wide")
    # add a title to the app
    st.title('Online Python Interpreter:computer:')
    # add a title to the app
    st.subheader("Welcome to Online Python Interpreter!")
    st.write("This is a simple application that helps you to run your Python code online.")
