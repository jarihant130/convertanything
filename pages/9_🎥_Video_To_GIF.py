...
def video2gif():
    ...
    st.set_page_config(page_title="Video To GIF Converter!!", page_icon=":movie_camera:", layout="wide")
    # add a title to the app
    st.title("Video To GIF Converter :movie_camera:")
    st.subheader("Welcome to Video To GIF Converter!")
    st.write("This is a simple application that convert Video into GIF with the help of Python.")
    ...
    if uploaded_file is not None:
        ...
        ## Default page ##   
            ...
            st.warning("Please upload a video file and enter a path to save the GIF file.")
